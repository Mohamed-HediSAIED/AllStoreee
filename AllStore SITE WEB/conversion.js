...
(function(){
  ...
  (function(){
    ...
    var reviews=[
      {name:'Sarah M.',initials:'SM',date:'Il y a 3 jours',stars:5,text:'Qualité incroyable, impossible de faire la différence. Livraison rapide et emballage soigné. Je recommande à 100% !'},
